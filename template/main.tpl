  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div id="column2">
        ...
        <p>
          This standards compliant website template is a themed version of the previously
          released 'turn_it_up' design. It is released as an 'open source' design
          (under the <a href="http://creativecommons.org/licenses/by/2.5">Creative Commons
          Attribution 2.5 Licence</a>), which means that you are free to download and use it
